...
**The Core Seattle Landlord Exit Script:**
"Hi, my name is [name]. I'm calling about the property on [street] — I believe it's currently a rental. I work with buyers in Seattle and I know there have been a lot of changes to the tenant laws over the last several years — the just cause eviction requirements, the notice rules. I've talked to a lot of landlords in the city who are just done navigating it and ready to simplify. I wanted to reach out and see if you'd had any thoughts about your plans."

What makes this opener effective:
1. It demonstrates specific knowledge of the Seattle regulatory environment
2. It validates the landlord's frustration without being inflammatory
3. It frames selling as simplification rather than failure
4. It ends with an open question rather than a hard ask
...
1. **Absentee owners with out-of-state mailing addresses** in Seattle city proper (King County assessor data)
2. **Long-term owner lists** in South Seattle zip codes (98118, 98108, 98144, 98122)
3. **King County probate records** (especially for older homeowners in established neighborhoods)
4. **Pre-foreclosure / lis pendens** from King County Superior Court (for south and east King County)
