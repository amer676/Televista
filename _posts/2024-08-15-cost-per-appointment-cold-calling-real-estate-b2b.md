---
layout: post
title: "Cost Per Appointment for Cold Calling: Real Numbers (2024 + Updated 2026)"
date: 2024-08-15
last_modified_at: 2026-05-18
description: "What does a qualified cold-call appointment actually cost? Real benchmarks by industry, by model (in-house vs outsourced vs VA), and the hidden costs everyone forgets."
target_keyword: "cost per appointment cold calling"
categories: [blog]
tags: ["cost per appointment", "cold calling pricing", "appointment setting cost", "SDR economics", "real estate cold calling"]
...
The cleanest 2025 number comes from [Leads at Scale's pricing guide](https://leadsatscale.com/insights/b2b-appointment-setting-pricing-guide-complete-2025-breakdown/), which compiled data across SMB, mid-market, and enterprise B2B:
...
5. **DNC scrubbing** (federal + state — required, [TCPA opt-out rules effective April 11, 2025](https://www.bclplaw.com/en-US/events-insights-news/the-tcpas-new-opt-out-rules-take-effect-on-april-11-2025-what-does-this-mean-for-businesses.html))
6. **Call recording + QA review**
7. **Reporting / dashboards**
8. **Management overhead** (the manager hours nobody counts)

If an agency's quote includes #1–#7 but you have to manage them — count your time. The [Bridge Group SDR Metrics Report](https://blog.bridgegroupinc.com/sales-development-metrics) shows the median SDR turnover is ~32%/year. If you're managing 2 in-house callers, expect to spend 8–12 hours/month on recruiting, interviewing, and onboarding replacements at $75–$150/hr opportunity cost. That's another $600–$1,800/mo nobody puts in the comparison.
...
- **Salary**: Salary.com lists the [SDR average at $70,434](https://www.salary.com/research/salary/opening/sales-development-representative-sdr-salary) (range $60,259–$80,609, April 2026)
- **Median OTE**: $85,000 ([RepVue](https://www.repvue.com/salaries/sales-development-representative))
- **Fully loaded**: $125,000–$150,000/year per rep (salary + payroll tax + benefits + software + management) — [Leads at Scale's analysis](https://leadsatscale.com/insights/in-house-sdr-vs-outsourced-sdr-complete-cost-performance-analysis/)
- **Ramp time**: 3.2 months average ([Bridge Group](https://blog.bridgegroupinc.com/sales-development-metrics))
...
- **$7–$14.50/hr** for trained cold-calling VAs ([VA Masters](https://vamasters.com/how-much-does-a-virtual-assistant-cost/))
- **$1,120–$1,920/month** full-time
- **30–40% annual attrition** in Philippines vs <15% in Caribbean ([CallForce Global](https://callforce.global/blog/call-center-outsourcing-cost/))
...
Cheap on paper. Expensive when you factor TCPA compliance (you inherit the agency's compliance posture — see our [2026 compliance update](/blog/2026/01/05/tcpa-one-to-one-consent-rule-vacated-real-estate-investor-compliance-2026/)), accent matching for sensitive real estate conversations, and time zone management.
...
Industry standard pay-per-meeting rates: **$75–$300/appointment** ([Leads at Scale 2025](https://leadsatscale.com/insights/b2b-appointment-setting-pricing-guide-complete-2025-breakdown/)). The cheaper end usually means the bar is on the floor.
...
**2. Compliance liability.** A single TCPA violation runs $500–$1,500 per call. The [April 2025 opt-out rules](https://www.bclplaw.com/en-US/events-insights-news/the-tcpas-new-opt-out-rules-take-effect-on-april-11-2025-what-does-this-mean-for-businesses.html) require you to honor consent revocation within 10 business days *by any reasonable method*. If your VA or offshore caller doesn't have a documented revocation workflow, you inherit the liability. State mini-TCPA laws (Florida, Washington, Oklahoma, Maryland) add per-incident damages.
...
We're transparent about every number on [our pricing page](/pricing.html) — including what's *not* included (data is per-campaign, not bundled). If you'd like to talk through your numbers, [book a 30-minute strategy call](/contact.html). We'll run your campaign math against industry benchmarks and tell you whether you're overpaying.
