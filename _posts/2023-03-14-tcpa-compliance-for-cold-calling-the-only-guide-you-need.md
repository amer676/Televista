...
categories: [blog]
tags: ["TCPA", "compliance", "cold calling", "DNC", "legal", "regulations"]
...
At [Televista](/services.html), TCPA compliance is baked into every campaign we run. This guide covers everything you need to know to stay on the right side of the law.

## What the TCPA Actually Says

The TCPA prohibits:

1. **Calling numbers on the National Do Not Call Registry** without prior express consent
2. **Using an automatic telephone dialing system (ATDS) or prerecorded voice** to call cell phones without prior express consent
3. **Calling before 8 AM or after 9 PM** in the called party's local time zone
4. **Failing to identify the caller** and provide contact information when requested
5. **Continuing to call someone who has asked to be placed on your internal do-not-call list**
...
At [Televista](/services.html), our dialer systems automatically enforce time zone restrictions so no call ever goes out in a non-compliant window.
...
1. **Stop calling immediately** — not after the next campaign, not next week, now
2. **Add them to your internal DNC list** within a reasonable time (industry standard is within 24 hours)
3. **Honor that request indefinitely** — there's no expiration on internal DNC requests
4. **Ensure all callers and campaigns respect the list** — if you have multiple callers or campaigns, your internal DNC must be shared across all of them
...
At [Televista](/services.html), every caller is trained on TCPA compliance before they ever make a live call. Our dialer systems handle DNC scrubbing, time zone enforcement, and call recording automatically. We maintain compliance documentation for every campaign we run.
...
Need help setting up a compliant cold calling campaign? [Reach out to our team](/contact.html) and we'll walk you through how we handle it.
