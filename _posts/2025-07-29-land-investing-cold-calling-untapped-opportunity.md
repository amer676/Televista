...
1. **Acquire at 10-30% of retail market value.** Because competition is low and many owners are highly motivated, you can often buy vacant land at steep discounts.
2. **Resale at 50-100% of market value** through owner financing (seller financing to the end buyer), which allows you to sell at or near full price with monthly payments.
3. **Or wholesale the contract** to another land investor or end buyer for a quick assignment fee.
...
- **Build a virtual team.** Land calls are simpler to train for, making it easier to onboard callers. Services like [Televista](/services.html) can handle land-focused cold calling campaigns alongside your residential outreach.
...
1. **Week 1**: Choose 2-3 target counties. Pull vacant land owner data. Skip trace and clean the lists.
2. **Week 2**: Start calling 50-100 owners per day. Use the scripts above and log every conversation.
3. **Week 3**: Follow up on warm leads. Research comparable sales for any interested sellers. Make your first offers.
4. **Week 4**: Close or assign your first deal. Evaluate your metrics and refine your targeting.
