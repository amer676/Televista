...
1. Earn the first 10 seconds (your opening hook)
2. Earn the next 30 seconds (relevant problem identification)
3. Earn the next 2 minutes (value proposition and social proof)
4. Earn the meeting (clear next step with a specific time)
...
**Day 1:** Send a personalized LinkedIn connection request with a brief note
**Day 2:** Send an email referencing a specific challenge their company faces
**Day 3:** Make the cold call, referencing your email: "I sent you a note yesterday about..."
**Day 5:** Follow-up email with a relevant case study or resource
**Day 7:** Second call attempt
**Day 10:** LinkedIn message with industry insight
**Day 14:** Final call attempt with a "break-up" message
